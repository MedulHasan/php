	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form id="form" action="../s_dashboard/s_dashboard.php" method="post">
					
					<input class="text email" type="email" name="email" id="email" placeholder="Enter Your Email and collect your id" required="">
